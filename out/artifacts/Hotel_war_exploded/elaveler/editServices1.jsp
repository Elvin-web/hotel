                                        ...
                                        <form action="ses?action=addServices1" method="post"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-inputU" value="${services.name}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <select name="multiple-selectU"  style="width: 400px;" id="multiple-selectU" multiple="multiple" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input1U" value="${services.amount}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <textarea name="textarea-input" style="width: 400px;" id="textarea-inputU" rows="9"
                                                              placeholder="Content..." class="form-control">${services.description}</textarea>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <div class="form-check">
                                                        <div class="checkbox">
                                                            <label for="checkbox1U" class="form-check-label ">
                                                                <input type="checkbox" id="checkbox1U" name="checkbox1U"<c:if test="${services.action==1}">checked </c:if>  value="1" class="form-check-input">
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
...
<script type="text/javascript">
    ...
    $(function () {
        $('#selectU').val('${services.priceType.id}');
    })
</script>
