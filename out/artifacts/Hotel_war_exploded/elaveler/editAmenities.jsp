                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Amenities Form</strong> Elements
                                </div>
                                <div class="card-body card-block">
                                    <form action="as?action=updateAmenities" method="post"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-inputU" value="${amenities.name}"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                      <textarea name="description" id="textarea-inputU"  rows="9"
                                       placeholder="Content..." class="form-control">${amenities.description}</textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                ...
                                                <div class="form-check">
                                                    <div class="checkbox">
                                                        <label for="checkbox1U" class="form-check-label ">
                                                            <input type="checkbox" id="checkbox1U" name="action1" <c:if test="${amenities.action==1}">checked </c:if> class="form-check-input"/>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-footer">
                                            <a href="javascript: updateAmenities('${amenities.id}');">
                                            <button type="button" class="btn btn-primary btn-sm"
                                                    id="amenitiesSubmitIdU">
