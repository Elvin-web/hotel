                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="cis?=addCity1" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="nameId" class=" form-control-label">Name</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                ...
                                <div class="card-footer">
                                    <button type="button" class="btn btn-primary btn-sm" id="citySubmitId">
