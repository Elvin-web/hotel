...
<div class="page-wrapper">
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            <h3 class="title-5 m-b-35"> Position data table</h3>
            <div class="table-data__tool">
                <div class="table-data__tool-left">
                    <div>
                        <input class="au-input au-input--xl" type="text" id="advPositionValueId" placeholder="Position"/>
                    </div>
                </div>
                <div class="table-data__tool-right">
                    <button class="au-btn au-btn-icon au-btn--blue au-btn--small"   id="advSearchBtnId">Search</button>
                    <a href="ps?action=addPosition"><button class="au-btn au-btn-icon au-btn--green au-btn--small" >add</button></a>
                </div>
            </div>
            <div class="table-responsive table-responsive-data2">
                <table class="table table-data2">
                    ...
                    <c:forEach items="${positionList}" var="pl">
                        <tr class="tr-shadow">
                            <td>${pl.r}</td>
                            <td>${pl.positionValue}</td>
                            <td>
                                <div class="table-data-feature">
                                    <a href="ps?action=editPosition&id=${pl.id}">
                                    <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                        <i class="fas fa-pencil-alt"></i>
                                    </button></a>
                                    <a href="javascript: deletePosition('${pl.id}','${pl.positionValue}');">
...
<script src="js1/position.js"></script>
