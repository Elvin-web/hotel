                            ...
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="hs?action=addHotel" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input3" class=" form-control-label">Address</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input3" name="text-input" placeholder="Address" class="form-control">
                                                <small class="form-text text-muted">Please enter address</small>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input2" class=" form-control-label">Phone</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="select" class=" form-control-label">Star</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                ...
                                <div class="card-footer">
                                    <button type="button" class="btn btn-primary btn-sm" id="hotelSubmitId">
