                                        ...
                                        <form action="ds?action=updateDictionary" method="post"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-inputU" value="${room.roomNumber}"
                                                           name="text-inputU" placeholder="Room number" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <select name="multiple-selectU" style="width: 400px;" id="multiple-selectU" multiple class="form-control">
                                            ...
                                            <a href="javascript: updateDictionary('${dictionaryList.id}');">
...
<script type="text/javascript">
    $(function () {
       ...
       $('#multiple-selectU').Array('${dictionaryList.amenities.id}');
    })
</script>
</body>
<!--     <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <c:forEach items="${amenitiesList}" var="al">
                                                        <div class="form-check" style="position: relative">
                                                            <div class="checkbox">
                                                                <label for="action1U" class="form-check-label "><option value="${al.id}">${al.name}</option>
                                                                    <input type="checkbox" id="action1U" name="action1"
                                                                           value="1"
                                                                           <c:if test="${dictionaryList.amenities.id!=null}">checked </c:if>
