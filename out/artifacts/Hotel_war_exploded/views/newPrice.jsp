                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="cs?action=addAmenities" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary btn-sm" id="amenitiesSubmitId">
