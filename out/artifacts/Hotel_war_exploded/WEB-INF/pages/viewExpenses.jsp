                            ...
                            <div class="col-lg-12">
                                <div class="card"  style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                       <form action="dos?action=dowloadExpenses&id=${expenses.id}" method="post"

                                              enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label"><strong>Date</strong></label>&nbsp;
                                                </div>
                                                <big id="select" class="form-text text-muted">${expenses.dataInsert}</big>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input" class="form-text text-muted">${expenses.name}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input1" class=" form-control-label"><strong>Expenses
                                                        category</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input1"
                                                         class="form-text text-muted">${expenses.expensesCategory.expensesType}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select1" class=" form-control-label"><strong>Amount</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="select1"
                                                         class="form-text text-muted">${expenses.amount}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select1" class=" form-control-label"><strong>Attachment</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="select2"
                                                         class="form-text text-muted">${expenses.document}</big>
                                                </div>
                                            </div>
                                            <a href="dos?action=dowloadExpenses&id=${expenses.id}">
                                                <button type="submit" class="btn au-btn--blue">
                                                    <i class="fas fa-download"></i>    Dowload
                                                </button>
                                            </a>
                                            <a href="es?action=getExpensesList">
                                                <button type="button"
                                                        class="btn btn-primary btn-sm"
                                                        id="expensesSubmitIdU"
