                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="as?action=addAmenities1" method="post"
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <big id="select" class="form-text text-muted">${amenities.name}</big>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input"
                                                         class="form-text text-muted">${amenities.description}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input1"
                                                         class="form-text text-muted">${amenities.action}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <a id="select1" class="item-gallery-sidebar wrap-pic-w" href="${filePath2}"
                                                       data-lightbox="gallery-footer">
                                                        <img src="${filePath2}" alt="GALLERY">
                                                    </a>
                                                </div>
                                            </div>
                                                <a href="as?action=getAmenitiesList">
