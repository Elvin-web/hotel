                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="rs?action=addReservation1" method="post"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="number" style="width: 400px;" id="text-inputU" value="${reservation.adults}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="number" style="width: 400px;" id="text-input1U" value="${reservation.children}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input2U" value="${reservation.checkIn}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input3U" value="${reservation.checkOut}"
                                                    ...
                                                    <div class="form-check">
                                                        <div class="checkbox">
                                                            <label for="checkbox1U" class="form-check-label ">
                                                                <input type="checkbox" id="checkbox1U"  name="extraBed" <c:if test="${reservation.extaBed==1}">checked </c:if> name="checkbox1" value="1" class="form-check-input">
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <a href="javascript: updateReservation('${reservation.id}');">
...
<script type="text/javascript">
    $(function () {
        ...
        $('#selectU').val('${reservation.guest.id}');
        $('#select1U').val('${reservation.roomType.id}');
    });
</script>
</body>
