                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="hss?action=addHousekeepingStatus1" method="post"
                                              enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-inputU"
                                                           class=" form-control-label"><strong>Title</strong></label>
                                                    <input type="text" style="width: 400px;" id="text-inputU" value="${housekeepingStatus.name}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <textarea name="textarea-input" style="width: 400px;" id="textarea-inputU" rows="9"
                                                              placeholder="Content..." class="form-control">${housekeepingStatus.description}</textarea>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <div class="form-check">
                                                        <div class="checkbox">
                                                            <label for="checkbox1U" class="form-check-label ">
                                                                <input type="checkbox" id="checkbox1U" <c:if test="${housekeepingStatus.action==1}">checked </c:if> name="checkbox1" value="1" class="form-check-input">
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <a href="javascript: updateHousekeepingStatus('${housekeepingStatus.id}');">
