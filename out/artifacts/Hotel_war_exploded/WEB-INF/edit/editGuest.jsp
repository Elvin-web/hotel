                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="gs?action=updateGuest" method="post"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-inputU" value="${guest.guestName}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input1U" value="${guest.guestSurname}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="inline-radio1U"
                                                           class=" form-control-label"><strong>Gender</strong></label> &nbsp;
                                                    <div class="form-check-inline form-check">
                                                        <label for="inline-radio1U" class="form-check-label ">
                                                            <input type="radio" id="inline-radio1U" <c:if test="${guest.gender eq 'male'}">checked </c:if> name="male"
                                                                   value="male" class="form-check-input">Male
                                                        </label>&nbsp;
                                                        <label for="inline-radio2U" class="form-check-label ">
                                                            <input type="radio" id="inline-radio2U" <c:if test="${guest.gender eq 'female'}">checked </c:if> name="female" name="inline-radios"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input4U" value="${guest.dob}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input2U" value="${guest.phone}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="email-inputU" value="${guest.email}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input3U"
                                                           class=" form-control-label"><strong>ID</strong></label>
                                                    <input type="text" style="width: 400px;" id="text-input3U" value="${guest.passportNumber}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="file" style="width: 400px;" id="file-input" value="${guest.image1}"
                                            ...
                                            <a class="item-gallery-sidebar wrap-pic-w" href="${filePath2}" data-lightbox="gallery-footer">
                                                <img src="${filePath2}" alt="GALLERY" style="width: 210px;height: 150px">
                                            </a>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="file-input"
                                                           class=" form-control-label"><strong>Image</strong></label>
                                                    <input type="file" style="width: 400px;" id="file-input1" value="${guest.image2}"
                                                           name="fileName1" class="form-control">
                                                    <small class="form-text text-muted">Please enter image</small>
                                                </div>
                                            </div>
                                            <a class="item-gallery-sidebar wrap-pic-w" href="${filePath4}" data-lightbox="gallery-footer">
                                                <img src="${filePath4}" alt="GALLERY" style="width: 210px;height: 150px">
                                            </a>
