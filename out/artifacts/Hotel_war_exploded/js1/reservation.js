...
function updateReservation(reservationId) {
    ...
    $.ajax({
        url: 'rs?action=updateReservation',
        type: 'POST',
        dataType: 'text',
        data: data,
        success: function (response) {
...
function updateReservation1(reservationId) {
    ...
    $.ajax({
        url: 'rs?action=updateReservation1',
        type: 'POST',
        dataType: 'text',
        data: data,
        success: function (response) {
...
function updateReservation2(reservationId) {
    ...
    $.ajax({
        url: 'rs?action=updateReservation2',
        type: 'POST',
        dataType: 'text',
        data: data,
        success: function (response) {
...
function updateReservationRoom(reservationRoomId) {
    ...
    $.ajax({
        url: 'rs?action=updateReservationRoom',
        type: 'POST',
        dataType: 'text',
        data: data,
        success: function (response) {
...
function addReservationRoom(reservationId) {
    ...
    $.ajax({
        url: 'rs?action=addReservationRoom',
        type: 'POST',
        dataType: 'text',
        data: data,
        success: function (response) {
...
function addServiceReservation(reservationId) {
    ...
    $.ajax({
        url: 'ses?action=addServiceReservation',
        type: 'POST',
        dataType: 'text',
        data: data,
        success: function (response) {
...
function deleteReservation(reservationId, name) {
    ...
    if (isDelete) {
        $.ajax({
            url: 'rs?action=deleteReservation',
            type: 'POST',
...
function advancedSearchReservationData() {
    ...
    $.ajax({
        url: 'rs?action=advancedSearchReservationData',
        type: 'GET',
        data: data,
        dataType: 'html',
        success: function (response) {
