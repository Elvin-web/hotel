    ...
    <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
            <form action="ls?action=login" method="post">
                ...
                <a class="btn btn-primary btn-block" href="index2.jsp">Login</a>
            </form>
                    ...
                    <div class="login-form">
                        <form action="ls?action=login" method="post">
                            ...
                            <div class="login-checkbox">
                                ...
                                <label>
                                    <a href="ls?action=forgotPassword">Forgotten Password?</a>
                                </label>
                            </div>
                            ...
                            <div class="social-login-content">
                                <div class="social-button">
                                    <button class="au-btn au-btn--block au-btn--blue m-b-20">sign in with facebook
                                    </button>
