...
<head>
    ...
    <link rel="stylesheet" href="./sogo/css/aos.css">
...
<header class="site-header js-site-header">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-6 col-lg-4 site-logo" data-aos="fade"><a href="webSite3.jsp">Royal Hotel</a></div>
                            ...
                            <div class="row full-height align-items-center">
                                <div class="col-md-6 mx-auto">
                                    <ul class="list-unstyled menu">
                                        <li class="active"><a href="webSite3.jsp">Home</a></li>
                                        <li><a href="rooms.jsp">Rooms</a></li>
                                        <li><a href="about.jsp">About</a></li>
                                        <li><a href="events.jsp">Events</a></li>
                                        <li><a href="contact.jsp">Contact</a></li>
                                        <li><a href="reservation.jsp">Reservation</a></li>
                                        <li><a href="ws?action=login">Sign In</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<section class="site-hero overlay" style="background-image: url(sogo/images/hero_4.jpg)" data-stellar-background-ratio="0.5">
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5" data-aos="fade-up">
                <figure class="img-absolute">
                    <img src="sogo/images/food-1.jpg" alt="Image" class="img-fluid">
                </figure>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4" data-aos="fade-up">
                <a href="#" class="room">
                    <figure class="img-wrap">
                        <img src="sogo/images/img_1.jpg" alt="Free website template" class="img-fluid mb-3">
                    </figure>
            ...
            <div class="col-md-6 col-lg-4" data-aos="fade-up">
                <a href="#" class="room">
                    <figure class="img-wrap">
                        <img src="sogo/images/img_2.jpg" alt="Free website template" class="img-fluid mb-3">
                    </figure>
                    <div class="p-3 text-center room-info">
                        <h2>Family Room</h2>
            ...
            <div class="col-md-6 col-lg-4" data-aos="fade-up">
                <a href="#" class="room">
                    <figure class="img-wrap">
                        <img src="sogo/images/img_3.jpg" alt="Free website template" class="img-fluid mb-3">
                    </figure>
                    <div class="p-3 text-center room-info">
...
<section class="section bg-image overlay" style="background-image: url('sogo/images/hero_3.jpg');">
    <div class="container">
        <div class="row justify-content-center text-center mb-5">
            <div class="col-md-7">
            ...
            <div class="js-carousel-2 owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="testimonial text-center slider-item">
                    <div class="author-image mb-3">
                        <img src="sogo/images/person_1.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
                    </div>
                    <blockquote>
                ...
                <div class="testimonial text-center slider-item">
                    <div class="author-image mb-3">
                        <img src="sogo/images/person_2.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
                    </div>
                    <blockquote>
                ...
                <div class="testimonial text-center slider-item">
                    <div class="author-image mb-3">
                        <img src="sogo/images/person_3.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
                    </div>
                    <blockquote>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="media media-custom d-block mb-4 h-100">
                    <a href="#" class="mb-4 d-block"><img src="sogo/images/img_1.jpg" alt="Image placeholder" class="img-fluid"></a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
                <div class="media media-custom d-block mb-4 h-100">
                    <a href="#" class="mb-4 d-block"><img src="sogo/images/img_2.jpg" alt="Image placeholder" class="img-fluid"></a>
                    <div class="media-body">
                        <span class="meta-post">February 26, 2018</span>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="300">
                <div class="media media-custom d-block mb-4 h-100">
                    <a href="#" class="mb-4 d-block"><img src="sogo/images/img_3.jpg" alt="Image placeholder" class="img-fluid"></a>
                    <div class="media-body">
                        <span class="meta-post">February 26, 2018</span>
...
<section class="section bg-image overlay" style="background-image: url('sogo/images/hero_4.jpg');">
    <div class="container" >
        <div class="row align-items-center">
