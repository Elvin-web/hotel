                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="pas?action=addPayment1" method="post"
                                              enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group" >
                                                <div class="col col-md-3">
                                                    <label for="text-input4"
                                                           class=" form-control-label"><strong>Reservation</strong></label>
                                                    <input readonly  type="text" style="width: 400px; "  id="text-input4" value="${reservation.id}"
                                            ...
                                            <div class="row form-group" >
                                                <div class="col col-md-3">
                                                    ...
                                                    <input readonly type="text" style="width: 400px;" id="text-input9" value="${payment.id}"
                                                           name="text-input9" placeholder="Payment Id" class="form-control">
