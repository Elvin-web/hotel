                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="rts?action=getRoomTypeList" method="post"
                                            ...
                                            <div class="row">
                                                <div class="table-responsive col-md-6">
                                                    <table class="table" style="width: 100%; border-block:none" >
                                                        ...
                                                        <tr>
                                                            <td style="border: none">
                                                                Base Occupancy  : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${roomType.roomStructure.baseOccupancy}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: none">
                                                                Higher Occupancy  : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${roomType.roomStructure.higherOccupancy}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: none">
                                                                Extra Bed  : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${roomType.roomStructure.extaBed}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: none">
                                                                Kids Occupancy  : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${roomType.roomStructure.kidsOccupancy}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: none">
                                                                Base Price  : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${roomType.price.basePrice}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border: none">
                                                                Extra Bed Price  : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${roomType.price.extraBedPrice}
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="table" style="width: 100%; border-block:none" >
                                                        ...
                                                        <tr>
                                                            <td style="border: none"> <a class="item-gallery-sidebar wrap-pic-w" href="${filePath2}"
                                                                ...
                                                                <img src="${filePath2}" alt="GALLERY" style="width: 90%;height: 110%;border-radius: 8px">
                                                            </a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                            ...
                                            <a href="rts?action=getRoomTypeList">
