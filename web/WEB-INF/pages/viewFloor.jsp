                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="fs?action=getFloorList" method="post"
                                              enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label"><strong>Name</strong></label>&nbsp;
                                                </div>
                                                <big id="select" class="form-text text-muted">${floor.name}</big>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input" class="form-text text-muted">${floor.floorNumber}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input1"
                                                         class="form-text text-muted">${floor.description}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <big id="select1"
                                                         class="form-text text-muted">${floor.action}</big>
                                                </div>
                                            </div>
                                            <a href="fs?action=getFloorList">
