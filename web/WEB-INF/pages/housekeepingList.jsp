            ...
            <div class="card mb-3" style="border: none">
                <div class="card-header">Housekeeping &nbsp;<small>List</small>
                    <div class="btn-group fa-pull-right">
                            <a href="hos?action=addHousekeeping&id=${roomId}">
                                    ...
                                    <td>
                                        <div class="btn-group" style="float: right">
                                            <a class="btn au-btn--green"
                                               href="hos?action=viewHousekeeping&id=${hl.id}">
                                                <i class="fas fa-eye"></i>View
                                            </a>
                                            <a class="btn btn-primary"
                                               href="hos?action=editHousekeeping&id=${hl.id}">
                                                <i class="fas fa-pencil-alt"></i>Edit
                                            </a>
                                            <a class="btn btn-danger"
                                               href="javascript: deleteHousekeeping('${hl.id}','${hl.id}');">
