                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="hos?action=housekeepingList" method="post"
                                              enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label"><strong>Room number</strong></label>&nbsp;
                                                </div>
                                                <big id="select" class="form-text text-muted">${housekeeping.room.roomNumber}</big>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <big id="select2"
                                                         class="form-text text-muted">${housekeeping.staff.name} ${housekeeping.staff.surname}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <big id="select3"
                                                         class="form-text text-muted">${housekeeping.cleanDate}</big>
                                                </div>
                                            </div>
                                            <a href="ds?action=getDictionaryList">
