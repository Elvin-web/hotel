...
<div class="page-wrapper">
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            <h3 class="title-5 m-b-35"> expenses category data table</h3>
            <div class="table-data__tool">
                <div class="table-data__tool-left">
                    <div>
                        <input class="au-input au-input--xl" type="text" id="advExpensesCategoryId"
                ...
                <div class="table-data__tool-right">
                    ...
                    <a href="ecs?action=addExpensesCategory">
            ...
            <div class="table-responsive table-responsive-data2">
                <table class="table table-data2">
                    ...
                    <c:forEach items="${expensesCategoryList}" var="ecl">
                        <tr class="tr-shadow">
                            <td>${ecl.r}</td>
                            <td>${ecl.expensesType}</td>
                            <td>
                                <div class="table-data-feature">
                                    <button class="item" data-toggle="tooltip" data-placement="top" title="Send">
                                        <i class="fas  fa-location-arrow"></i>
                                    </button>
                                    <a href="ecs?action=editExpensesCategory&id=${ecl.id}">
