                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Reservation Form</strong> Elements
                                </div>
                                    ...
                                    <form action="rs?action=updateReservationRoom" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <a href="javascript: updateReservationRoom('${reservationRoomId.id}');">
                                                <button type="button" class="btn btn-primary btn-sm" id="reservationRoomSubmitIdU">
...
<!--<script type="text/javascript">
    $(function () {
        $('#selectU').val('${reservation.roomType.dictionary.room.roomNumber}');
    });
</script>-->
</body>
