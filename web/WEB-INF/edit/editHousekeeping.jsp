                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="hos?action=updateHousekeeping" method="post"
                                              enctype="multipart/form-data" class="form-horizontal">
                                            <input type="hidden" name="id" value="${housekeeping.room.id}" id="roomId">
                                           ...
                                           <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;"  readonly="readonly" id="text-input2U" value="${housekeeping.room.roomNumber}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input4U" value="${housekeeping.cleanDate}"
