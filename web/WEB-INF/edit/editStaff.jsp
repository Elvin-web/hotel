                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="ss?action=updateStaff" method="post"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input2" value=" ${staff.email}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input11"
                                                           name="ID1" placeholder="ID" value="${staff.ID}"
                                                           class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input9" value=" ${staff.username}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input10" value=" ${staff.password}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input value="${staff.image}" type="file" style="width: 400px;" id="file-input"
                                                           name="fileName" class="form-control" >
                                                    <small class="form-text text-muted">Please enter image</small>
                                                    <a class="item-gallery-sidebar wrap-pic-w" href="${filePath2}"
                                                       data-lightbox="gallery-footer">
                                                        <img src="${filePath2}" alt="GALLERY" width="120px" height="120px">
                                                    </a>
                                                </div>
                                            </div>
