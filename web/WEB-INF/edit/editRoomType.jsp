                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="rts?action=updateRoomType" method="post"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-inputU" value="${roomType.roomType}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input1U" value="${roomType.slug}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input2U" value="${roomType.shortCode}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="number" style="width: 400px;" id="text-input3U" value="${roomType.roomStructure.baseOccupancy}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="number" style="width: 400px;" id="text-input4U" value="${roomType.roomStructure.higherOccupancy}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="number" style="width: 400px;" id="text-input5U" value="${roomType.roomStructure.kidsOccupancy}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input6U" value="${roomType.price.basePrice}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input8U" value="${roomType.price.extraBedPrice}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <textarea name="description" style="width: 400px;" id="textarea-inputU" rows="9"
                                                              placeholder="Content..." class="form-control">${roomType.description}</textarea>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="file" style="width: 400px;" id="file-input"
                                                           name="fileName" placeholder="Name" class="form-control-file"  value="${roomType.image}">
                                                    ...
                                                    <div class="form-check">
                                                        <div class="checkbox">
                                                            <label for="checkbox1U" class="form-check-label ">
                                                                <input type="checkbox" id="checkbox1U"  name="extraBed" <c:if test="${roomType.roomStructure.extaBed==1}">checked </c:if> name="checkbox1" value="1" class="form-check-input">
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
