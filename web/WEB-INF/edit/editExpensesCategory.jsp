                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    <div class="card-header">
                                        <h5>Expenses Category Form  <small>edit</small></h5>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="ecs?action=addExpensesCategory1" method="post"
                                              enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-inputU"
                                                           class=" form-control-label"><strong>Name</strong></label>
                                                    <input type="text" style="width: 400px;" id="text-inputU" value="${expensesCategory.expensesType}"
