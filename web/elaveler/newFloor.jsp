                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="fs?action=addFloor1" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input1" class=" form-control-label">Floor number</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input1" name="text-input" placeholder="Floor number" class="form-control">
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" class="btn btn-primary btn-sm" id="floorSubmitId">
