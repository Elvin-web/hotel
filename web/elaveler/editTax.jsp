                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="ts?action=updateTax" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-inputU" class=" form-control-label">Name</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-inputU" value="${tax.name}" name="text-input" placeholder="Name" class="form-control">
                                                <small class="form-text text-muted">Please enter name</small>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input1U" class=" form-control-label">Code</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input1U" value="${tax.code}"  name="text-input" placeholder="Code" class="form-control">
                                                <small class="form-text text-muted">Please enter code</small>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="selectU" class=" form-control-label">Type</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input2U" class=" form-control-label">Tax Rate</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="number" step="0.1" id="text-input2U" value="${tax.rate}"  name="text-input" placeholder="Tax Rate" class="form-control">
                                ...
                                <div class="card-footer">
                                    <a href="javascript: updateTax('${tax.id}');">
