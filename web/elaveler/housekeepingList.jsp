...
<div class="page-wrapper">
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            <h3 class="title-5 m-b-35"> housekeeping data table</h3>
            <div class="table-data__tool">
                ...
                <div class="table-data__tool-right">
                    ...
                    <a href="hos?action=addHousekeeping">
            ...
            <div class="table-responsive table-responsive-data2">
                <table class="table table-data2">
                    ...
                    <c:forEach items="${housekeepingList}" var="hl">
                        <tr class="tr-shadow">
                            <td>${hl.r}</td>
                            <td>${hl.dictionary.room.roomNumber}</td>
                            <td>${hl.dictionary.room.floor.name}</td>
                            <td>${hl.housekeepingStatus.name}</td>
                            <td>${hl.staff.name} ${hl.staff.surname}</td>
                            <td>
                                <div class="table-data-feature">
                                    <a href="hos?action=viewHousekeeping&id=${hl.id}">
                                        <button class="item" data-toggle="tooltip" data-placement="top" title="View">
                                            <i class="fas fa-eye"></i>
                                        </button> </a>
                                    <a href="hos?action=editHousekeeping&id=${hl.id}">
                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <i class="fas fa-pencil-alt"></i>
                                        </button>
                                    </a>
                                    <a href="javascript: deleteHousekeeping('${hl.id}','${hl.id}');">
