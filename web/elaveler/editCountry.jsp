                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Country Form</strong> Elements
                                </div>
                                <div class="card-body card-block">
                                    <form action="cs?action=addCountry" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-inputU" value="${country.name}" name="text-input" placeholder="Name" class="form-control">
                                                <small class="form-text text-muted">Please enter name</small>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input1U" class=" form-control-label">Sortname</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input1U" value="${country.sortName}" name="text-input1" placeholder="Sortname" class="form-control">
                                ...
                                <div class="card-footer">
                                    <a href="javascript: updateCountry('${country.id}');">
                                    <button type="button" class="btn btn-primary btn-sm" id="countrySubmitIdU">
