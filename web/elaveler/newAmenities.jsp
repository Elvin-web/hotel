                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="as?=addAmenities" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <textarea name="description" id="descriptionId" rows="9"
                                                          placeholder="Content..." class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="fileName" class=" form-control-label">Image</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="card-footer">
                                            <button type="button" class="btn btn-primary btn-sm" id="amenitiesSubmitId">
