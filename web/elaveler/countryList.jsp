...
<div class="page-wrapper">
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            <h3 class="title-5 m-b-35"> country data table</h3>
            <div class="table-data__tool">
                <div class="table-data__tool-left">
                    ...
                    <div>
                        <input class="au-input au-input--xl" type="text" id="advSortNameId" placeholder="Sort name"/>
                    </div>

                </div>
                <div class="table-data__tool-right">
                    <a href="cos?action=addCountry"><button class="au-btn au-btn-icon au-btn--green au-btn--small" >add</button></a>
                        ...
                        <tr class="tr-shadow">
                            ...
                            <td>
                                <div class="table-data-feature">
                                    <a href="cos?action=editCountry&id=${cl.id}">
                                    <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                        <i class="fas fa-pencil-alt"></i>
                                    </button>
                                    </a>
                                    <a href="javascript: deleteCountry('${cl.id}','${cl.name}');">
