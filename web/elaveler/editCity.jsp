                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <strong>City Form</strong> Elements
                                </div>
                                <div class="card-body card-block">
                                    <form action="cis?=updateCity" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="nameIdU" class=" form-control-label">Name</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="nameIdU" value="${city.name}" name="name" placeholder="Name" class="form-control">
                                ...
                                <div class="card-footer">
                                    <a href="javascript: updateCity('${city.id}');">
                                    <button type="button" class="btn btn-primary btn-sm" id="citySubmitIdU">
