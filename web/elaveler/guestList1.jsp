        ...
        <div class="main-content">
            ...
            <div class="table-data__tool">
                <!-- <div class="table-data__tool-left">
                      <div class="rs-select2--light rs-select2--md">
                        <select class="js-select2" name="property">
                            <option selected="selected" id="advCountryCmbId">Select Country</option>
                    ...
                    <div class="rs-select2--light rs-select2--md">
                        <select class="js-select2" name="property">
                            <option selected="selected" id="advCityCmbId">Select City</option>
                            <c:forEach items="${cityList}" var="cl">
                    ...
                    <div class="rs-select2--light rs-select2--md">
                        <select class="js-select2" name="property">
                            <option selected="selected" id="advIDCmbId">Select ID</option>
                    ...
                    <div>
                        <input class="au-input au-input--xl" type="text" id="advEmailId" placeholder="email">
                    </div>
                    <div>
                        <input class="au-input au-input--xl" type="text" id="advIDId" placeholder="ID">
                    </div>
                ...
                <div class="table-data__tool-right">
                    ...
                    <a href="gs?action=addGuest">
                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">add</button>
                    </a>
                </div>
            </div>
            <div class="table-responsive table-responsive-data2" id="guestDivId">
                <table class="table table-data2" id="guestTableId">
                    <thead>
                    <tr>
                        <th>#</th>
                        <th>name</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-data-feature">
                                    <a href="gs?action=viewGuest&id=${gl.id}">
                                    ...
                                    <a href="gs?action=paymentGuest&id=${gl.id}">
                                    <button class="item" data-toggle="tooltip" data-placement="top" title="Payment">
