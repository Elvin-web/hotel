                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="es?action=addExpenses1" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="row form-group">
                                              ...
                                              <div class="col-12 col-md-9">
                                                  <input type="text" id="text-input" name="text-input" placeholder="Date"
                                                         class="form-control">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="select" class=" form-control-label">Expenses
                                                    category</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input2" class=" form-control-label">Amount</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="file-input" class=" form-control-label">Attachment</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                ...
                                <div class="card-footer">
                                    <button type="button" class="btn btn-primary btn-sm" id="expensesSubmitId">
