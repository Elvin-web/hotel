                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="cos?action=addCountry1" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input1" class=" form-control-label">Sortname</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input1" name="text-input1" placeholder="Sortname" class="form-control">
                                ...
                                <div class="card-footer">
                                    <button type="button" class="btn btn-primary btn-sm" id="countrySubmitId">
