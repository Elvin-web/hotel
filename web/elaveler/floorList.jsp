...
$(function () {
$('#floorTableId').DataTable();
});
</script>
<table class="display" id="floorTableId">
<thead>
<tr>
<th>#</th>
<th>Name</th>
...
<div class="page-wrapper">
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            <h3 class="title-5 m-b-35"> floor data table</h3>
            <div class="table-data__tool">
                <div class="table-data__tool-left">
                    ...
                    <div>
                        <input class="au-input au-input--xl" type="text" id="advFloorNumberId"
                        ...
                        <tr class="tr-shadow">
                            ...
                            <td>
                                <div class="table-data-feature">
                                    <a href="fs?action=viewFloor&id=${fl.id}">
                                    <button class="item" data-toggle="tooltip" data-placement="top" title="View">
                                        <i class="fas  fas fa-eye"></i>
                                    </button></a>
                                    <a href="fs?action=editFloor&id=${fl.id}">
                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <i class="fas fa-pencil-alt"></i>
                                        </button>
                                    </a>
                                    <a href="javascript: deleteFloor('${fl.id}','${fl.name}');">
