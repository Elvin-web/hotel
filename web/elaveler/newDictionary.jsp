                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Room Form</strong> Elements
                                </div>
                                <div class="card-body card-block">
                                    <form action="ds?action=addDictionary" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="text-input" placeholder="Room number" class="form-control">
                                                <small class="form-text text-muted">Please enter room number</small>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="select" class=" form-control-label">Floor</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="multiple-select" class=" form-control-label">Amenities</label>
                                            </div>
                                ...
                                <div class="card-footer">
                                    <button type="button" class="btn btn-primary btn-sm" id="dictionarySubmitId">
